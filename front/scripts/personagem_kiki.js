...
async function iniciar() {
    ...
    const atividadesMoon = dados.atividades.filter(
        atividade => atividade.personagem === "Kiki"
    );
...
const imgs_animacao = [
    "../acervo/personagens/kiki/Kiki fala 2.png",
    "../acervo/personagens/kiki/Kiki fala 3.png"
];

const img_padrao = "../acervo/personagens/kiki/Kiki fala 1.png"
